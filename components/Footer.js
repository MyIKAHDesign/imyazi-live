    ...
    <footer class="bg-white dark:bg-gray-900">
      <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400">
            <li class="mb-4">
              <a href="/ibufuliiru" class="hover:underline">Ibufuliiru</a>
            </li>
            <li class="mb-4">
              <a href="/kifuliiru" class="hover:underline">Kifuliiru</a>
            </li>
            <li class="mb-4">
              <a href="/bafuliiru" class="hover:underline">Bafuliiru</a>
            </li>
            <li class="mb-4">
              <a href="/congo" class="hover:underline">Congo RDC</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
          ...
          <a href="https://www.instagram.com/Ibufuliiru/" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
          ...
          <a href="https://www.twitter.com/Ibufuliiru/" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
          ...
          <a href="https://ibufuliiru.editorx.io/ibufuliiru" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <span class="sr-only">Ibufuliiru.com</span>
          </a>
        </div>
      </div>
    </footer>
